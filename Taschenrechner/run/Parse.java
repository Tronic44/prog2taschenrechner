...
//	
	 ...
	 * @param check die zu �berpr�fende Zeichenkette
	...
	/**
	 * Entfernt alle 'null' -Objecte und "sortiert" das Array neu und k�rzt es auf die minimale Gr��e
	 * @param all
	...
	public static Object resort(Object[] all) throws FailException{
		...
		Object[] allmini = all;
		//das gek�rzte Array wird jetzt im sinne von punkt vor strich durchgegangen und berechnet
		Object result;
